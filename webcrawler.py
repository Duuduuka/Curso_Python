...
Original file is located at
    https://colab.research.google.com/drive/16FuGPAN9qlWE5itr14Rwk4qJpiIRbPBj
"""
...
for page in pages:
  ...
  movie_containers = page_html.find_all('div', class_= 'lister-item mode-avanced')
  for container in movie_containers:
      if container.find('div', class_= 'ratings-metascore') is not None:
        ...
        if container.p.find('span', class_= 'certificate') is not None:
          rating= container.h3.find('span', class_= 'certificate').text
          rating.append(year)
        ...
        if container.p.find('span', class_= 'genre') is not None:
          genre= container.h3.find('span', class_= 'genre').text.replace("\n","").rstrip().split('.')
          genre.append(year)
